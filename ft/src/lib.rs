    ...
    pub fn new_default_meta(owner_id: ValidAccountId, total_supply: U128) -> Self {
        Self::new(
            ...
            FungibleTokenMetadata {
                ...
                name: "Reality Token".to_string(),
                symbol: "reality".to_string(),
                icon: Some(DATA_IMAGE_SVG_REALITY_ICON.to_string()),
                reference: "https://chaverocoin.com/token.json".to_string(),
                reference_hash: None,
                decimals: 24,
            },
        )
